import os, sys, sqlite3, threading, webbrowser
...
if getattr(sys, "frozen", False):  # running as EXE
    BASE_DIR = os.path.join(os.environ["APPDATA"], "Rework")
else:
    BASE_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), "data")

LOCAL_DB = os.path.join(BASE_DIR, "rework.db")
